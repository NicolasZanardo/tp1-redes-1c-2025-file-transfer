...
class TestConsistentlyLossySocket(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.lossy_sock = ConsistentlyLossySocket(sock=self.mock_sock, loss_period=3)

    def tearDown(self):
        self.mock_sock.reset_mock()

    def test_initialization(self):
        lossy_sock = ConsistentlyLossySocket(sock=self.mock_sock, loss_period=5)
    ...
    def test_sendto_loss_period_one(self):
        lossy_sock = ConsistentlyLossySocket(sock=self.mock_sock, loss_period=1)
    ...
    def test_sendto_loss_period_two(self, mock_logger):
        lossy_sock = ConsistentlyLossySocket(sock=self.mock_sock, loss_period=2)
    ...
    def test_loss_period_zero(self):
        with self.assertRaises(ZeroDivisionError):
            lossy_sock = ConsistentlyLossySocket(sock=self.mock_sock, loss_period=0)

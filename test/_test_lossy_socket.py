...
class TestLossySocket(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.lossy_sock = LossySocket(sock=self.mock_sock, loss_rate=0.2)
    ...
    def test_initialization(self, mock_random):
        lossy_sock = LossySocket(sock=self.mock_sock, loss_rate=0.5)
    ...
    def test_sendto_zero_loss_rate(self, mock_random):
        lossy_sock = LossySocket(sock=self.mock_sock, loss_rate=0.0)
    ...
    def test_sendto_full_loss_rate(self, mock_logger, mock_random):
        lossy_sock = LossySocket(sock=self.mock_sock, loss_rate=1.0)
